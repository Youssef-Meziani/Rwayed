 ...
 */
final class Version20240314170007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pneu CHANGE prix_unitaire prix_unitaire DOUBLE PRECISION DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pneu CHANGE prix_unitaire prix_unitaire DOUBLE PRECISION NOT NULL');
    }
}
